...
#     "manual_edits": ["info.yml core_version_requirement", "Twig spaceless"],
...
#
# Usage:
#   port-report.sh --subject DIR [--manifest FILE] [--output DIR]
#
# Output: writes <output>/port-report.md (default: the subject dir) and prints its
#         path on STDOUT. Logging on STDERR.
...

{
  ...
  printf '### Manual edits\n\n'; mlist '.manual_edits' | bullets; printf '\n'
